...
namespace HotWalletsTrialApp.Migrations
{
    ...
    [Migration("20221112172822_RenameCreateAccountIdToCreatedByAccountIdForAllTable")]
    partial class RenameCreateAccountIdToCreatedByAccountIdForAllTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotWalletsTrialApp.Models.Concrete.Wallet", b =>
                {
                    b.HasOne("HotWalletsTrialApp.Models.Concrete.Account", "Account")
                        .WithOne("Wallet")
                        .HasForeignKey("HotWalletsTrialApp.Models.Concrete.Wallet", "AccountId")
