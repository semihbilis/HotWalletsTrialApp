    ...
    public class EfContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Account>()
                        .HasMany(a => a.AuthorizationList)
                        .WithOne(aut => aut.Account)
                        .HasForeignKey(s => s.AccountId);

            modelBuilder.Entity<WalletAuthorization>()
                        .HasOne(aut => aut.Account)
                        .WithMany(a => a.AuthorizationList)
                        .HasForeignKey(s => s.AccountId)
                        .OnDelete(DeleteBehavior.NoAction);
            modelBuilder.Entity<WalletAuthorization>()
                        .HasOne(aut => aut.Wallet)
            ...
            modelBuilder.Entity<Wallet>()
                        ...
                        .WithOne(aut => aut.Wallet)
                        .HasForeignKey(s => s.WalletId);
            modelBuilder.Entity<Wallet>()
                        .HasMany(w => w.TransactionList)
            ...
            modelBuilder.Entity<Category>()
                        .HasMany(c => c.WalletTransactionList)
                        .WithOne(wt => wt.Category)
                        .HasForeignKey(s => s.CategoryId);
        }
    }
}
